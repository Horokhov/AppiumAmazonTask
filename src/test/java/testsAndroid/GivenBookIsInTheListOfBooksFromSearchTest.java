...
public class GivenBookIsInTheListOfBooksFromSearchTest extends BaseTestAndroid {
    ...
    public void searchGivenBookInTheListOfBooksTest() throws IOException, InterruptedException {
        ...
        Thread.sleep(3000);
        List<Book> bookList  = amazonBooksActions.collectEachBookInTheList();
        Thread.sleep(3000);
        Book givenBook = amazonBooksActions.getGivenBookInfo("https://www.amazon.com/Head-First-Java-Kathy-Sierra/dp/0596009208/ref=sr_1_2?dchild=1&keywords=Java&qid=1610356790&s=books&sr=1-2");
